...
и взятые в работу соответстувющим регионом
    """,
    'pd_3_column':
        """
Количество работающих сотрудников в определенный день 

(которые закрывали обращения) 
    """,
    'pd_4_column':
        """
Общее количество обращений, поступивших за период [2] 

деленное на

Количество работающих сотрудников в определенный день [3] 
 
    """,
    'pd_5_column':
        """
Распределение поступивших заявок и сотрудников в разрезе подсистем 
 
    """,
    'pd_6_column':
        """
Количество задач, у которых не указана категория обращения
